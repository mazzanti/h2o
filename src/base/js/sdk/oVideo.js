...
nsNessuno.oVideo = function(sParent, sName) {
    "use strict";
    var self = this;
    ...
    this.draw = function() {
        ...
        //
        // this.sList = "http: //www.w3schools.com/html/horse.ogg;http://www.w3schools.com/html/horse.ogg";
        this.aData = this.sList.split(";");

        sHtml += "<video style=\"width:100%; height:100%;\"";
        ...
        sHtml += "Your browser does not support the video element.";
        sHtml += "</video>";
...
nsNessuno.oToolboxItem.oVideo = function() {
    "use strict";
    var self = nsNessuno.oToolboxItem._idForm;
    var iDi = self.getNewHandle();

    self.pnlContentDesigner[iDi] = new nsNessuno.oVideo(self.pnlContentDesigner.getName(), self.pnlContentDesigner.getChildName(iDi));
